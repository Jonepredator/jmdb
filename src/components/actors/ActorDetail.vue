<template>
  <div class="container mx-auto px-4 py-16 flex">
    <div class="flex-none">
      ...
      <ul class="flex items-center mt-4">
        <li>
          <a href="">
            <svg
              class="fill-current text-gray-500 hover:text-white w-5"
              viewBox="0 0 448 512"
            >
              <path
    ...
    <div class="ml-20">
      ...
      <div class="flex mt-2">
        <svg
          class="fill-current text-gray-500 hover:text-white w-4"
          viewBox="0 0 448 512"
        >
          <path
        ...
        <span class="ml-2 text-gray-500 text-sm">1988-12-16 (31)</span>
      </div>
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-5">
        <div :key="movie.id" v-for="movie in this.knownFor">
          <router-link
            :to="`/movie/${movie.id}`"
            class="text-sm leading-normal text-gray-300 hover:text-white"
          >
            <img
              :src="movieImage(movie)"
              alt="poster"
              class="mt-2 hover:opacity-75 transition ease-in-out duration-150"
            />
